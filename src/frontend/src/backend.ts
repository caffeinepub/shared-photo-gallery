...
import type { ExternalBlob as _ExternalBlob, Photo as _Photo, PhotoId as _PhotoId, Time as _Time, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getPhotoBlob(arg0: PhotoId): Promise<ExternalBlob> {
        if (this.processError) {
            try {
    ...
    async uploadPhoto(arg0: string, arg1: string, arg2: ExternalBlob): Promise<PhotoId> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadPhoto(arg0, arg1, await to_candid_ExternalBlob_n12(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deletePhoto(arg0: PhotoId): Promise<void> {
        if (this.processError) {
            try {
                await this.actor.deletePhoto(arg0);
            } catch (e) {
                this.processError(e);
                throw new Error('unreachable');
            }
...
async function from_candid_vec_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Photo>): Promise<Array<Photo>> {
